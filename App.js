...
let chal = new Audio('chal.wav');
let loss = new Audio('lost.wav');
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (item.style.backgroundColor == 'green' && item.innerText.length == 0) {
            ...
            document.querySelectorAll('.box').forEach(i => {
                if (i.style.backgroundColor == 'pink') {
                    ...
                    loss.play();
                    if(lost.charAt(0) == 'B'){
                            curr = document.getElementById('Bstep').innerHTML ;
                            document.getElementById('Bstep').innerText = `${ +curr - 1 }`;
                    } else {
                            curr = document.getElementById('Wstep').innerHTML ;
                            document.getElementById('Wstep').innerText = `${ +curr - 1 }`;
                    }
        ...
        document.getElementById('steps').innerHTML = `${tog -1 }`;
